      ...
      <section className="text-center">
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-4 py-2.5 text-sm font-semibold text-gray-700 transition-colors hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
          >
      ...
      <section className="mt-16">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-3 text-center text-gray-600 dark:text-gray-400">
            Recent updates and improvements to DevTools.
          </p>
          <div className="mt-8 space-y-4">
            {[
              {
                date: "Sep 2026",
                title: "Phase 4 improvements",
                desc: "Added FAQPage schema for rich snippets, author bio, GitHub badge, usage stats bar, and Most Popular tool badges.",
              },
              {
                date: "Sep 2026",
                title: "11 new tools added",
                desc: "Terraform Generator, Dockerfile Generator, Helm Chart Generator, Token Counter, and 7 more tools across DevOps, FinTech, and AI categories.",
              },
              {
                date: "Sep 2026",
                title: "Guide pages launched",
                desc: "5 new guide pages covering JSON formatting, JWT decoding, Base64 encoding, UUID generation, and regex testing.",
              },
              {
                date: "Sep 2026",
                title: "Privacy-first redesign",
                desc: "Complete homepage rebuild with privacy narrative, How It Works section, Standards & References, and Quick Comparisons.",
              },
            ].map((item, i) => (
              <div
                key={i}
              ...
              >
                <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-blue-100 text-xs font-bold text-blue-700 dark:bg-blue-900/50 dark:text-blue-300">
                  {item.date.split(" ")[0]}
                </div>
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-white">
